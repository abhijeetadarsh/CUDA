...
int main()
{
	...
	printf("Host single-pricision representation of 128.1 = %.20f\n", hostF);
	printf("Host double-precision representation of 128.1 = %.20f\n", hostD);
	printf("Device single-precision representation of128.1 = %.20f\n", h_deviceF);
	printf("Device double-precision representation of128.1 = %.20f\n", h_deviceD);
