...
int main() {
	...
	// allocte host locked memory, used to stream
	...
	printf("The single stream with ID %d was created and the total time taken for ( data transfer, computation) is %8.6f ms\n", stream, elapsedTime);
	
	// clean the streams and memory
